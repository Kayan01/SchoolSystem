...
namespace LearningSvc.Core.Migrations
{
    ...
    [Migration("20210423090806_kearningd")]
    partial class kearningd
    {
            ...
            modelBuilder.Entity("LearningSvc.Core.Models.Notice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationTime = new DateTime(2021, 4, 23, 10, 8, 6, 392, DateTimeKind.Local).AddTicks(2147),
                            Description = "Testing"
                        },
                        new
                        {
                            Id = 2L,
                            CreationTime = new DateTime(2021, 4, 23, 10, 8, 6, 392, DateTimeKind.Local).AddTicks(4052),
