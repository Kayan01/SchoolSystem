...
namespace LearningSvc.Core.Services.Interfaces
{
    public interface ILearningFileService
    {
        ...
        Task<ResultModel<List<LearningFileListVM>>> GetAllFileByTeacher(long teacherId, LearningFileType fileType);
        Task<ResultModel<List<LearningFileListVM>>> GetAllFileByClass(long classId);
        Task<ResultModel<List<LearningFileListVM>>> GetAllFileByClass(long classId, LearningFileType fileType);
