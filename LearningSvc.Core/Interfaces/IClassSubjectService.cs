...
namespace LearningSvc.Core.Interfaces
{
    public interface IClassSubjectService
    {
        ...
        Task<ResultModel<List<ClassSubjectWithAssignmentCountVM>>> GetSubjectsForClassWithAssignmentCount(long classId);
        Task<ResultModel<List<ClassSubjectWithFilesCountVM>>> GetSubjectsForClassWithFilesCount(long classId);
    }
}
