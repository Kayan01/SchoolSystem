...
{
    class ApprovedResultService_GetClassTeacherApprovedClassBroadSheet
    {
        [Test]
        public async Task GetClassTeacherApprovedClassBroadSheet_ApprovedResultExists()
        {
            using (ServicesDISetup _setup = new ServicesDISetup())
            {
                ...
                var rtn = await approvedService.GetClassTeacherApprovedClassBroadSheet(student.Class.Id);
        ...
        [Test]
        public async Task GetClassTeacherApprovedClassBroadSheet_ApprovedResultDoesNotExists()
        {
            using (ServicesDISetup _setup = new ServicesDISetup())
            {
                var approvedService = _setup.ServiceProvider.GetService<IApprovedResultService>();
