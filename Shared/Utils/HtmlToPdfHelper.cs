...
namespace Shared.Utils
{
    public static class HtmlToPdfHelper
    {
        ...
        public static byte[] ConvertToPDFBytesToList<T>(this IConverter converter, T mainData, IEnumerable<T> tableData, TableAttributeConfig tableConfig, string htmlTemplatePath, bool isLandscape = false)
        {
            ...
            {
                ["Table"] = tableData.ToHtmlTable(
                    tableAttributes: tableConfig.TableAttributes,
                    tbAttributes: tableConfig.TbAttributes,
                    thAttributes: tableConfig.ThAttributes,
        ...
        public static byte[] ConvertToPDFBytesToList<T>(this IConverter converter, IEnumerable<T> data, string htmlTemplatePath, bool isLandscape = false)
        {
        ...
        public static byte[] ConvertToPDFBytes<T>(this IConverter converter, T data, string htmlTemplatePath, bool isLandscape = false)
        {
            ...
            {
                tableKey.Add(prop.Name, prop.GetValue(data, null) == null ? "N/A" : prop.GetValue(data, null).ToString());
            }
    ...
    public static partial class HtmlTableHelper
    {
        ...
        private static class HtmlTableGeneraterFactory
        {
        ...
        private class HtmlTableGenerater
        {
            ...
            public string ToHtmlTableByProperties<T>(IEnumerable<T> enums)
            {
                ...
                if (props.Count == 0)
                {
                    throw new AppGenericException("At least one Property");
                }
                #endregion
    ...
    public class TableAttributeConfig
    {
        public object TableAttributes { get; set; }
        public object ThAttributes { get; set; }
        public object TdAttributes { get; set; }
        public object TbAttributes { get; set; }
    ...
    public static partial class HtmlTableHelper
    {
        internal static class CustomAttributeHelper
        {
                ...
                , MemberInfo memberInfo)
            {
                ...
                return customAttributes.FirstOrDefault(w => w?.memberInfo?.Name == memberInfo.Name);
            }
        }
