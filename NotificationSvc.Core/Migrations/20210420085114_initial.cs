    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2021, 4, 20, 9, 51, 13, 448, DateTimeKind.Local).AddTicks(9104), null, "Testing", null, null });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "Id", "CreationTime", "CreatorUserId", "Description", "Entity", "EntityId" },
                values: new object[] { 2L, new DateTime(2021, 4, 20, 9, 51, 13, 449, DateTimeKind.Local).AddTicks(2790), null, "Unit Test", null, null });

            migrationBuilder.InsertData(
                table: "UserNotification",
                columns: new[] { "NotificationId", "UserId", "DateRead", "IsRead" },
                values: new object[] { 1L, 1L, new DateTime(2021, 4, 20, 9, 51, 13, 454, DateTimeKind.Local).AddTicks(6048), true });
