    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2021, 7, 6, 9, 49, 40, 652, DateTimeKind.Local).AddTicks(5015), null, "Testing", null, null });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "Id", "CreationTime", "CreatorUserId", "Description", "Entity", "EntityId" },
                values: new object[] { 2L, new DateTime(2021, 7, 6, 9, 49, 40, 652, DateTimeKind.Local).AddTicks(7352), null, "Unit Test", null, null });

            migrationBuilder.InsertData(
                table: "UserNotification",
                columns: new[] { "NotificationId", "UserId", "DateRead", "IsRead" },
                values: new object[] { 1L, 1L, new DateTime(2021, 7, 6, 9, 49, 40, 657, DateTimeKind.Local).AddTicks(9454), true });
