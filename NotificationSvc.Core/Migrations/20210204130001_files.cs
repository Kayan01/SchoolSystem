    ...
    public partial class files : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2021, 2, 4, 14, 0, 0, 992, DateTimeKind.Local).AddTicks(2944), null, "Testing", null, null });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "Id", "CreationTime", "CreatorUserId", "Description", "Entity", "EntityId" },
                values: new object[] { 2L, new DateTime(2021, 2, 4, 14, 0, 0, 992, DateTimeKind.Local).AddTicks(4837), null, "Unit Test", null, null });

            migrationBuilder.InsertData(
                table: "UserNotification",
                columns: new[] { "NotificationId", "UserId", "DateRead", "IsRead" },
                values: new object[] { 1L, 1L, new DateTime(2021, 2, 4, 14, 0, 0, 995, DateTimeKind.Local).AddTicks(1547), true });
