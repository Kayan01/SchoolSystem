...
namespace NotificationSvc.Core.Migrations
{
    ...
    [Migration("20210204130001_files")]
    partial class files
    {
            ...
            modelBuilder.Entity("NotificationSvc.Core.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationTime = new DateTime(2021, 2, 4, 14, 0, 0, 992, DateTimeKind.Local).AddTicks(2944),
                            Description = "Testing"
                        },
                        new
                        {
                            Id = 2L,
                            CreationTime = new DateTime(2021, 2, 4, 14, 0, 0, 992, DateTimeKind.Local).AddTicks(4837),
            ...
            modelBuilder.Entity("NotificationSvc.Core.Models.UserNotification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            NotificationId = 1L,
                            UserId = 1L,
                            DateRead = new DateTime(2021, 2, 4, 14, 0, 0, 995, DateTimeKind.Local).AddTicks(1547),
                            IsRead = true
                        },
                        new
                        {
