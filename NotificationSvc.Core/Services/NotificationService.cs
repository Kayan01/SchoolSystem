    ...
    public class NotificationService : INotificationService
    {
        ...
        private async Task SendEmailNotification(List<CreateEmailModel> emailMessages)
        {
            foreach (var emailMessage in emailMessages)
            {
                ...
                await _emailService.SendEmail(new[] { emailMessage.User.Email }, emailMessage.EmailTemplateType, emailMessage.ReplacementData,emailMessage.SenderName, emailMessage.Attachments);
            }
        }
